...
[최신 릴리스](https://github.com/autobile/autobile/releases/latest)에서 `autobile-0.1.0.apk`를
...
여는 모든 화면을 볼 수 있습니다. 나머지 두 권한은 선택입니다. 알림 접근은 알림 트리거를,
다른 앱 위에 표시는 실행 중 진행 상황 표시를 켭니다.
...
173개의 단위 테스트와 실기기에서 축소된 릴리스 빌드로 실행되는 계측 테스트가 이를 검증합니다.
